package screens.ingamescreens
{
	...
	public class FarCoastDingyEmbedded extends Sprite
	{
		...
		public function FarCoastDingyEmbedded(_assets:AssetManager,increment:Function,callback:Function)
		{
			super();
			assets = _assets;
			...
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/FarCoastDingy/FarCoastDingy_Sprite_02.png'));
			this.assets.enqueue(File.applicationDirectory.resolvePath('./media/graphics/InGame/FarCoastDingy/FarCoastDingy_Sprite_02.xml'));
